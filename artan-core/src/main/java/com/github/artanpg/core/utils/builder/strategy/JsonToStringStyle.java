 ...
 * output of the {@code toString} method in Json format.
 *
 * @author Mohammad Yazdian
 */
public class JsonToStringStyle extends AbstractToStringStyleStrategy {
    ...
    private JsonToStringStyle() {
        ...
        setArrayTerminator("]");
        setContentStarter("\"");
        setContentTerminator("\"");
        setContentSeparator(":");
    }

    public static JsonToStringStyle of() {
        return new JsonToStringStyle();
    }
    ...
    protected void appendFieldNames(String fieldName) {
        Asserts.hasText(fieldName, "Field names are mandatory when using JsonToStringStyle");
        super.appendFieldNames(fieldName);
    }
